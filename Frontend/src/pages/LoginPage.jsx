      ...
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-2xl backdrop-blur-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-xs sm:text-sm text-gray-400 mt-1.5 sm:mt-2">
            Welcome back! Sign in to access your interview plans.
          </p>
        </div>
          ...
          <div className="mb-6 flex items-start gap-3 p-3.5 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-sm animate-in fade-in duration-150">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0-2.694-1.667-3.464 0L3.34 16c-.77-1.333.192-3.464 1.732-3.464z"
              />
            </svg>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                onChange={() => apiError && setApiError(null)}
                className="block w-full pr-10 rounded-xl bg-white/5 border border-white/10 px-3.5 py-2.5 text-sm text-white placeholder:text-gray-500 outline-none transition focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400"
              />
              <button
                type="button"
                onClick={() => setShowPassword((prev) => !prev)}
                className="absolute right-0 top-0 h-full flex items-center px-3 text-gray-500 hover:text-gray-300"
